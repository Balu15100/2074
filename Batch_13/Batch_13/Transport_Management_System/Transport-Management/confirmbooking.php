          ...
          <div class="col-md-3"></div>
           <div class="col-md-6">
              <div class="page-header">
                ...
                <p><strong>Pickup Date: </strong><?php echo $row['pic_date']; ?></p> 
                
                
                <p><strong>Pickup Time: </strong><?php echo $row['pic_time']; ?></p> 
                
                
                <p><strong>Delivery Date: </strong><?php echo $row['dil_date']; ?></p> 
                
                
                <p><strong>Delivery Time: </strong><?php echo $row['dil_time']; ?></p> 
               ...
               <form action="sendmail.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Available Trucks</b></span>

<?php
   ...
   $conn=mysqli_connect('localhost','root','','transport management');
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="form-group">
          ...
          <input required type="text" class="form-control" name="salary" placeholder="Salary" value="<?php echo $std['fare']?>">
        </div>
        
        <div class="form-group">
          <label for="Age">Other :</label>
          <input type="text" class="form-control" name="equipment" placeholder="Equipment" value="<?php echo $std['other']?>">
        </div>

        <div class="form-group">
          <label for="Address">Fuel :</label>
          <input type="text" class="form-control" name="oil" placeholder="Oil" value="<?php echo $std['fuel']?>">
        </div>

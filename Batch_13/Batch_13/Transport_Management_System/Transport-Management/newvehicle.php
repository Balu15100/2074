<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $res=false;
        $insert_query="INSERT INTO `vehicle`(`veh_id`, `veh_reg`, `chesisno`, `brand`, `veh_color`, `veh_regdate`, `veh_description`, `veh_photo`) VALUES ('','$regno','$chesisno','$brand','$color','$regdate','$description','$photo')";
